...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds-devs")
    bq_project = Variable.get("bq_project", default_var="ascendant-talon-476816-c8")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "255440817709-compute@developer.gserviceaccount.com",
